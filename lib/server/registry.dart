...
List<ToolDefinition> _buildDefinitions() {
  return const <ToolDefinition>[
    ...
    ToolDefinition(
      ...
      title: 'Native Project Inspect',
      description: 'Inspect native project paths, schemes, and destination hints.',
      workflow: 'native_build',
      risk: RiskClass.readOnly,
      implemented: true,
      inputSchema: <String, Object?>{
        'type': 'object',
    ...
    ToolDefinition(
      ...
      title: 'Native Build Launch',
      description: 'Launch a native build and create a correlated session.',
      workflow: 'native_build',
      risk: RiskClass.runtimeControl,
      implemented: true,
      inputSchema: <String, Object?>{
        ...
        'properties': <String, Object?>{
          ...
          'scheme': <String, Object?>{'type': 'string'},
          'configuration': <String, Object?>{'type': 'string'},
          ...
          'attachFlutterRuntime': <String, Object?>{
            'type': 'boolean',
            'default': false,
          },
        },
    ...
    ToolDefinition(
      ...
      title: 'Native Attach Flutter Runtime',
      description: 'Attach a Flutter runtime to a native-launched session.',
      workflow: 'native_build',
      risk: RiskClass.runtimeControl,
      implemented: true,
      inputSchema: <String, Object?>{
    ...
    ToolDefinition(
      name: 'native_stop',
      title: 'Native Stop',
      description: 'Stop an owned native-launched session.',
      workflow: 'native_build',
      risk: RiskClass.runtimeControl,
      implemented: true,
      inputSchema: <String, Object?>{
